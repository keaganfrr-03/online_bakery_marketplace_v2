...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        products_data = [
            ...
            ("Vanilla Cake", "Classic vanilla cake", "Cakes", 12.99, 8, "products/cakes/cake12.jpg"),
            ...
            ("Sourdough Bread", "Artisan sourdough", "Breads", 15.99, 15, "products/breads/bread12.jpg"),
            ...
            ("Danish Pastry", "Fruit-filled danish", "Pastries", 14.50, 18, "products/pastries/pastry12.jpg"),
            ...
            ("Oatmeal Cookie", "Healthy oatmeal cookie", "Cookies", 11.50, 40, "products/cookies/cookie12.jpg"),
            ...
            ("Chocolate Donut", "Chocolate-covered donut", "Donuts", 11.50, 25, "products/donuts/donut12.jpg"),
            ...
            ("Garlic Knot", "Soft bread knot brushed with garlic butter", "Buns", 11.80, 20, "products/buns/bun12.jpg"),
            ...
            ("Cherry Pie Slice", "Sweet and tangy cherry filling", "Pies", 23.75, 12, "products/pies/pie12.jpg"),
            ...
            ("Vanilla Cupcake", "Classic vanilla cupcake with buttercream", "Cupcakes", 12.40, 18,
             "products/cupcakes/cupcake12.jpg"),
            ...
            ("Walnut Brownie", "Brownie topped with crunchy walnuts", "Brownies", 12.20, 20,
             "products/brownies/brownie12.jpg"),
